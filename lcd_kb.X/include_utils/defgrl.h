...
#define _XTAL_FREQ 20000000 //XC8 _XTAL_FREQ

//xc8:__delay_ms(x)
//avr> _delay_ms(x)  
#define _delay_ms(x) __delay_ms(x)  //compatible avr->microchip
...
#if defined(__PICC18__) || defined(__PICC__) || defined(__XC8) || defined __XC || defined(__SDCC_pic14)

#warning Using I/O definitions for MICROCHIP
